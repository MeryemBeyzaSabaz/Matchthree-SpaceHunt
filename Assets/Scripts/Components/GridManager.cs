...
namespace Components
{
    public partial class GridManager : SerializedMonoBehaviour, ITweenContainerBind
    {
        ...
        private void Awake()
        {
            ...
            {
                Debug.LogError("ProjectSettings is not injected.");
                return;
            }
        ...
        {
            if (_destroyNoise != null)
            {
                _destroyNoise.PlayDestroySound();
            }
        ...
        private void RegisterEvents()
        {
            ...
            if (InputEvents == null)   // NullReferenceException hatası için:
            {
                Debug.LogError("InputEvents is not injected.");
                return;
            }
